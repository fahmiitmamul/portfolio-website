...
export function BackgroundGradient() {
  ...
  useEffect(() => {
    ...
    const updateSpotPositions = () => {
      spots = [
        { x: 0, y: 0, radius: window.innerWidth * 0.6, color: "rgba(128, 0, 128, 0.15)" }, // Purple top left
        { x: window.innerWidth, y: 0, radius: window.innerWidth * 0.5, color: "rgba(128, 0, 128, 0.2)" }, // Purple top right
        { x: 0, y: window.innerHeight, radius: window.innerWidth * 0.5, color: "rgba(139, 0, 0, 0.15)" }, // Dark red bottom left
        {
    ...
    function addNoise(ctx: CanvasRenderingContext2D, width: number, height: number, alpha: number) {
    ...
    function addGrid(ctx: CanvasRenderingContext2D, width: number, height: number) {
