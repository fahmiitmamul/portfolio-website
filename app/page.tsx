...
export default function Homepage(): JSX.Element {
  ...
  return (
    <ConfigProvider theme={theme}>
      <div className="App">
        <div className="flex justify-between items-center w-full h-[70px] bg-white px-10 text-[#383838] fixed z-10">
          <div>
        ...
        <div className="flex w-full h-[800px] bg-gradient-to-tr from-blue-300 via-white to-orange-300">
          <div
            data-aos="fade-right"
            className="flex flex-auto w-64 flex-col text-[#383838] justify-center items-center"
          >
            <div className="flex flex-col max-w-2xl text-5xl font-black">
              <div>Hi 👋</div>
          ...
          <div
            data-aos="fade-left"
            className="flex-auto w-32 flex justify-center items-center"
          >
            <Image
              alt="fahmi"
              src={Profile}
        ...
        >
          <div className="w-full flex flex-col justify-center items-center text-3xl pt-10">
            ...
            <div className="text-xl px-20 text-center py-5">
        ...
        <div className="h-auto bg-blue-50 text-[#383838] px-20 py-20">
